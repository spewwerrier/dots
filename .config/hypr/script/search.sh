...
query=$(echo "" | bemenu -c --prompt "search ⌕   " --fn "Iosevka Extended 40" -M 40 --tf "#f3fa37")
BROWSER=brave
...
arguments=$(printf "%s\n" "aur" "google" "github" "ddg" "unix stack" "stack overflow" "youtube" "books" | bemenu --fn "Iosevka Extended 20"  --list 10 -b --prompt "⌕" --tf "#f3fa37" --hf "#000000" --hb "#ffffff" -c -M 500)
